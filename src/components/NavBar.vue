...
<template>
    ...
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-light bg-lightborder-bottom shadow-sm p-3 mb-5 bg-body rounded">
            <div class="container-fluid">
                <router-link to="/home" class="h4 sintd">E-Monedero</router-link>
                    ...
                    <ul class="navbar-nav ms-3">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-center">
                                ...
                                <li class="nav-item">
                                    <router-link to="/investmentAnalytic" class="dropdown-item">Análisis de
    ...
    <div class="modal fade" id="cerrarSesionMdl" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer mx-5">
                    ...
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" @click="logout">Cerrar
                        sesión</button>
                </div>
            </div>
        </div>
