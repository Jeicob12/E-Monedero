...
<template>
  ...
  <div>
    ...
    <div class="container my-5"  v-else>
      <form @submit.prevent="handlerSubmit" class="p-4 shadow-sm rounded bg-light">
        <div class="mb-4">
          ...
          <select class="form-select text-center" name="type" v-model="type" id="type"
            placeholder="Seleccione una moneda" required>
        ...
        <div class="mb-4">
          ...
          <div class="input-group">
            ...
            <input type="number" v-model="amount" step="0.00000000001" min="0" class="form-control"
              placeholder="Ej: 0.00001" />
          </div>
        </div>

        <button type="submit" class="btn btn-primary w-100 py-2" data-bs-toggle="modal" data-bs-target="#modalCompra">
          Buscar cotización
        </button>
      </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-success" data-bs-dismiss="modal" @click="purchaseCrypto">
                Comprar
              </button>
            </div>
          </div>
    ...
    <div v-if="isValidPurchase !== null" class="container mt-5">
      <div class="alert alert-success text-center" v-show="isValidPurchase">
        ¡Compra exitosa!
        <button type="button" class="btn-close" @click="isValidPurchase = null" aria-label="Close"></button>
      </div>
      <div class="alert alert-danger text-center" v-show="isValidPurchase === false">
